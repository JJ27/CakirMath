...
\begin{gather*}
    ...
    = vv'
\end{gather*}
Last step because the dot product of the same vector is $1$, and the dot product of orthogonal vectors($\vv{T}$ and $\vv{N}$) is $0$.
\begin{gather*}
...
\end{gather*}
This shows that there is at least one free variables and there are infinite solutions.
\end{proof}
