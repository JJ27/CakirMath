...
\end{gather*}
This is an interesting product for one because $\vv{a} \times \vv{b}$ will always be $\perp$ to $\vv{a}$ and $\vv{b}$(proved later). Notice that cross products are only defined for 3D vectors $\vv{a}$ and $\vv{b}$.
...
\begin{gather*}
    |\vv{a} \times \vv{b}|^2 = |\vv{a}|^2|\vv{b}|^2(1 - \cos^2(\theta)) = |\vv{a}|^2|\vv{b}|^2\sin(\theta)
\end{gather*}
\end{proof}
...
\caption{Volume of a Parallelogram}
\label{crossvol}
\end{center}
\end{figure}
